...
public class CapacitorHttpUrlConnection implements ICapacitorHttpUrlConnection {
    ...
    public void setRequestHeaders(JSObject headers) {
                // [patch-http-plugin-gradle] NPE fix: the JS wrapper may legally omit headers; call.getObject("headers") returns null and headers.keys() throws NullPointerException. Treat null as an empty header set.
        if (headers == null) {
